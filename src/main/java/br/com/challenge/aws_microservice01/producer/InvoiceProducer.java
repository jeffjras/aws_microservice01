package br.com.challenge.aws_microservice01.producer;
...
import br.com.challenge.aws_microservice01.repository.InvoiceSaleRepository;
...
public class InvoiceProducer {
    private static final Logger log = LoggerFactory.getLogger(
            InvoiceProducer.class);
    private ObjectMapper objectMapper;
    private InvoiceSaleRepository invoiceSaleRepository;
    private AmazonS3 amazonS3;

    @Autowired
    public InvoiceProducer(ObjectMapper objectMapper, InvoiceSaleRepository invoiceSaleRepository, AmazonS3 amazonS3) {
